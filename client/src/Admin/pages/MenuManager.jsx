        ...
        >
          ...
          <div className="p-6 space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              >
                {["plate", "wrap", "stick", "cup", "bowl", "piece", "portion"].map(
            ...
            <label className="flex items-center gap-3 cursor-pointer">
              <div
                ...
                style={{ background: form.available ? T.orange : "rgba(255,255,255,.15)" }}
...
export default function MenuManager({ items, onSave, showToast }) {
  ...
  const saveItem = (item) => {
    if (!item.name.trim())   { showToast("Name is required", "error"); return; }
    if (item.unitPrice <= 0) { showToast("Price must be > 0", "error"); return; }
        ...
        {filtered.map((item) => (
          ...
          >
            ...
            <div className="relative h-36 overflow-hidden">
              <img
                src={item.img || "https://images.unsplash.com/photo-1567620905732-2d1ec7ab7445?w=400"}
                alt={item.name}
              ...
              <span
                ...
                style={{
                  background: item.available ? "rgba(34,197,94,.25)" : "rgba(239,68,68,.25)",
            ...
            <div className="p-4 flex-1 flex flex-col">
              ...
              <div className="flex gap-2 mt-auto">
                ...
                <Btn small variant="outline" onClick={() => toggleAvail(item.id)}>
