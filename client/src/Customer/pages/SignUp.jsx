  ...
  return (
    <>
      ...
      <div
        ...
        style={{
          background: `linear-gradient(155deg,${T?.bg} 0%,#2d0d00 100%)`,
        }}
      >
        {/* Bokeh glow blobs */}
        ...
        <div className="relative z-10 w-full max-w-sm">
          ...
          >
            ...
            <Btn onClick={handleSignUp} style={{ width: "100%" }}>
              {loading ? "Signing up…" : "Sign Up →"}
            </Btn>

            <p className="text-xs text-center mt-4" style={{ color: T.muted }}>
              Already have an account?{" "}
              <Link to="/Login" style={{ color: T.orange }}>
                <button style={{ color: T.orange }}>Login here</button>
              </Link>
            </p>
          </div>
        </div>
